...
.this-header{
  background: url("<?php echo get_bloginfo('template_url') ?>/images/blog-wide.jpg");
}
@media screen and (max-width: 58em){
  .this-header{
    background: url("<?php echo get_bloginfo('template_url') ?>/images/blog-mobile.jpg");
  }
}
</style>
...
<header id="blog-header" class="layout-column-center flex default this-header" role="banner">
    <div class="contain flex layout-column-nowrap-center">
        <h1 style="font-weight: bold;">Planet Expat’s blog:</h1>
        <h3>Our HR experts' advice</h3>
    </div>
</header>
