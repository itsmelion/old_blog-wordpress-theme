		...
		<div class="brand">
			<li class="pe-footer-logo">
				<a title="<?php bloginfo( 'description' ); ?>" href="<?php echo home_url();?>">
					<img src="<?php echo get_bloginfo('template_url') ?>/images/logo-alt.png" alt="<?php bloginfo( 'name' ); ?>" />
				</a>
			</li>
			<li class="social">
				<a href="//facebook.com/PlanetExpat/" target="_blank" title="Facebook">
					<img src="<?php echo get_bloginfo('template_url') ?>/images/social-facebook.svg" alt="Facebook"/>
				</a>
				<a href="//twitter.com/PlanetExpat" target="_blank" title="Twitter: @PlanetExpat">
					<img src="<?php echo get_bloginfo('template_url') ?>/images/social-twitter.svg" alt="@PlanetExpat"/>
				</a>
				<a href="//linkedin.com/company/2949016/" target="_blank" title="LinkedIn">
					<img src="<?php echo get_bloginfo('template_url') ?>/images/social-linkedin.svg" alt="LinkedIn"/>
				</a>
			</li>
		</div>
